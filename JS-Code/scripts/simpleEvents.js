...
var chgColor = { red: 0, green: 0, blue: 0 };
function changeRed  (event) { changeColor('red',  16); }
function changeGreen(event) { changeColor('green',16); }
function changeBlue (event) { changeColor('blue', 16); }
